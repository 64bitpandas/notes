...
<embed src="humes-problem-of-induction.pdf" type="application/pdf" width="100%" height="600px" />

📎 Attached 1 image(s): page-99-1.png
## Scientism
...
Example: All squares have 4 corners.
This shape is a square → ☐
Conclusion: It has 4 corners. ← Always true ⇒ logically valid!
...
Request ID: cd39e159-53c7-4040-990c-4de762601b9b
...
**Induction:** All observed [A] are [B].
...
Request ID: 492cc17b-cb62-43ef-8b79-24469f346e7a
...
2. Hypothesis H₁ is the best explanation of O
   a. H₁ is good explanation (simple, elegant, unifying)
   b. H₁ is better than other hypotheses
   c. H₁ is true.
...
If the future resembles the past, induction works.
If it doesn't resemble the past, nothing works.
So it is safe to believe in induction because no other method would be reliable anyways.

- Doesn't actually justify induction

## A priori Defense

A priori knowledge: independent of individual observation; same no matter who observes it
...
Request ID: 101a293f-bace-4dc7-80cd-51fa67bed7c6
...
Feldman's definition of "justified": a method is justified


Request ID: c8d76a4d-f8c7-495c-a80e-ae09976883df
...
### Is \<Legal System\> legal?
- Meaningless question — by definition, a legal system must be legal in its jurisdiction

### Analogy for Belief-forming methods (Legal system) and Particular beliefs (Particular action):
...
Request ID: a4dd435f-5a3a-4b62-b566-1684709c64b6

📎 Attached 1 image(s): page-104-1.png
- **Hypothetical predicate _grue_:** iff X is first observed before 2025 and green OR X is not observed before 2025 and blue

Then, by induction, since all observed emeralds are grue, the new emerald will also be grue.
- → We would then predict the color to be _blue_ by induction…
- → It is possible to change 'blue' to _any_ property to predict anything. Therefore, different people can all use the same method and come to completely different conclusions.
...
1. **Induction should only be used with simple predicates**
   ...
   - Simplicity is a feature of language, _not_ a feature of sets themselves


Request ID: d91e3621-ca6f-4f5b-803a-632e9f8b70ef
