...
On the other hand, you can think of a queue like lining up for a ride at Disneyland. The first person who gets in line will get to go first, and the last person who gets in will go last. (Of course, we all know people cut and stuff- see [Priority Queues](/cs61b/abstract-data-types/collections/stacks-and-queues#priority-queues) to see how this is better handled.)
