...
1. Use Doppler shift equation to get $z = \frac{\lambda - \lambda_0}{\lambda_0}$
2. Use $z = \frac{v}{c}$ to calculate velocity $v$
3. Use Hubble’s law $v = H_0 d$ to calculate distance
