...
- **Genotype** vs **Phenotype**
  ...
  - Phenotype: expression of genes — possible observable traits ((Aa, AA) or (aa))
...
- X, Y **not** homologous (no match)
  - More likely to produce disorders in males (e.g. colorblindness [color sensitive rhodopsin proteins], hemophilia [blood clots])
